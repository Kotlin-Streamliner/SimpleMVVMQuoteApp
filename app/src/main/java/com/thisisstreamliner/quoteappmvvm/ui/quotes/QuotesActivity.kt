...
import com.thisisstreamliner.quoteappmvvm.R
import com.thisisstreamliner.quoteappmvvm.data.Quote
import com.thisisstreamliner.quoteappmvvm.utilities.InjectorUtils
...
class QuotesActivity : AppCompatActivity() {
    ...
    private fun initializeUI() {
        val factory = InjectorUtils.provideQutesViewModelFactory()
